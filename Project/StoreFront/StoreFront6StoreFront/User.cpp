...
void User::readStoreBin(string file) {
...
void User::readCartBin(string file) {
    fstream db(file, ios::in | ios::binary);
...
void User::reloadItms(string file) {
