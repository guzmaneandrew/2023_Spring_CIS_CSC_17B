...
int main(int argc, char** argv) {
    ...
    //Declare Variables
    Card **deck;            //Array of pointers to Card objects
    int nCards=52;          //If you construct an object with a constructor,
                            //must use double pointer
    
    //Initialize the deck
    deck=new Card*[nCards];   //Dynamically allocate array of 52 Card Pointers
    for(int i=0;i<nCards;i++){
        deck[i]=new Card(i);  //Create of each individual card
    }
